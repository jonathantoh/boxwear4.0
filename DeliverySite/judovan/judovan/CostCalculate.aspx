<%@ Page Title="" Language="C#" MasterPageFile="~/delivery.Master" AutoEventWireup="true" CodeFile="CostCalculate.aspx.cs" Inherits="judovan.CostCalculate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
        <div class="col">
                <div class="form-group">
                    <div class="col-xs-6"><asp:Label ID="economyTxt" name="economyTxt" placeholder="Economy" runat="server"></asp:Label></div>
				    <div class="col-xs-6"><asp:Label ID="expressTxt" name="expressTxt" placeholder="Express" runat="server"></asp:Label></div>
                  </div>
