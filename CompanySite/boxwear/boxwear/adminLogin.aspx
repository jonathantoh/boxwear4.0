<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="adminLogin.aspx.cs" Inherits="boxwear.adminLogin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="login-form">
        <h2 class="text-center"><asp:Image ID="Image1" ImageUrl="images/boxwear-resize.png" Height="57px" Width="154px" runat="server" />
            <span class="auto-style1"><strong><em>Admin</em></strong></span></h2>   
        <div class="form-group has-error">
        	<asp:TextBox class="form-control" name="email" ID="txtusername" placeholder="Enter Username" runat="server"></asp:TextBox>
        </div>
