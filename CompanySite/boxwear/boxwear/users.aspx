<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="users.aspx.cs" Inherits="boxwear.users" %>
...
<asp:Content ID="body" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
       ...
       <div class="signup-form">
		<h2><asp:Image ID="Image1" ImageUrl="~/images/boxwear-resize.png" runat="server" Height="57px" Width="154px" />
           </h2>
		<p>Please fill in this form to create an account with BoxWear!</p>
		<hr/>
		...
		<div class="form-group">
            <asp:Button ID="Register" class="btn btn-primary btn-lg" runat="server" Text="Create new user" OnClick="Register_Click" />
        </div>
